...
Technical documentation for the Geocon Project Timeline application.

| Document | Description |
|----------|-------------|
| [Architecture](./ARCHITECTURE.md) | System layers, data flow, authentication, real-time updates, extension guidelines |
| [API Reference](./API.md) | All HTTP endpoints, request/response formats, auth patterns |

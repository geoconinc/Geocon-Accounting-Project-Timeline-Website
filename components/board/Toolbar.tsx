...
export function Toolbar({
  ...
  const activeCount =
    filters.ownerIds.length + filters.statuses.length + (filters.hideCompleted ? 1 : 0);
  ...
  return (
    <div className="bg-white border-b border-slate-200 px-5 py-2.5 flex items-center gap-2 flex-wrap shrink-0">
      ...
      <div className="relative" ref={filterPop.ref}>
        ...
        {filterPop.open && (
          <div className="absolute z-30 top-full left-0 mt-1 w-72 bg-white border border-slate-200 rounded-md shadow-lg p-3 max-h-[400px] overflow-y-auto">

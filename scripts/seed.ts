...
async function main() {
  ...
  const setupForms = [
    { name: "DAS 140 & 142 Setup Form", status: "Completed" as const, due: "2026-04-23", owner: ml.id },
    { name: "DAS 140", status: "Missing" as const, due: null, owner: null },
    { name: "DAS 142", status: "Missing" as const, due: "2026-04-30", owner: null },
    ...
    { name: "Other Setup Forms", status: "NA" as const, due: null, owner: null }
  ];
